...
public class Constants {
    public static final AttributeKey<String> CHECK_AUTH_ATTRIBUTE_KEY = AttributeKey.valueOf("check-auth");
    ...
    public static final AttributeKey<String> ENCRYPT_KEY_ATTRIBUTE_KEY = AttributeKey.valueOf("encrypt-key");
}
