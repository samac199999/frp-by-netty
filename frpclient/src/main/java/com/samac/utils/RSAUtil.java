...
public class RSAUtil {
    ...
    public static byte[] encryptByPublicKeyNoPadding(byte[] data, String publicKey)
    		throws Exception {
        byte[] keyBytes = Base64Util.decode(publicKey);
        X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
     ...
     * @throws  
     */
    public static String encryptStringByPublicKeyNoPadding(String text, String publicKey) throws Exception {
    	
    	byte[] encodedData = encryptByPublicKeyNoPadding(text.getBytes("UTF-8"), publicKey);
